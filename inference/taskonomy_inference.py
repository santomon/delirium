...
def loader(path_to_image: str):
    taskonomy_command_str = "python {run_img_task_loc} --img {path_to_img} --store {path_to_out} --store-rep --task {model_name} --encoder_layer {layer} {compress} --suppress_stdout"
